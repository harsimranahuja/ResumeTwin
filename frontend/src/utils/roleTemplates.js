export const ROLE_TEMPLATES = {
  general: {
    ...
    techSuggestions: ['Project Management', 'Data Analysis', 'Reporting', 'Research', 'Process Improvement', 'Budgeting'],
    softSuggestions: ['Communication', 'Leadership', 'Problem Solving', 'Teamwork', 'Time Management', 'Conflict Resolution'],
  ...
  webdev: {
    ...
    techSuggestions: ['JavaScript', 'React', 'Node.js', 'TypeScript', 'CSS/SASS', 'HTML5', 'Git', 'REST APIs', 'SQL', 'MongoDB', 'Next.js'],
    softSuggestions: ['Problem Solving', 'Collaboration', 'Adaptability', 'Communication', 'Attention to Detail', 'Mentorship'],
  ...
  data: {
    ...
    techSuggestions: ['Python', 'SQL', 'Tableau', 'Power BI', 'Excel', 'Data Modeling', 'Statistics', 'R', 'Pandas'],
    softSuggestions: ['Analytical Thinking', 'Problem Solving', 'Communication', 'Attention to Detail', 'Presentation Skills', 'Teamwork'],
  ...
  marketing: {
    ...
    techSuggestions: ['SEO/SEM', 'Google Analytics', 'Content Strategy', 'Social Media', 'Email Marketing', 'A/B Testing', 'HubSpot', 'Copywriting'],
    softSuggestions: ['Creativity', 'Communication', 'Collaboration', 'Adaptability', 'Time Management', 'Critical Thinking'],
  ...
  design: {
    ...
    techSuggestions: ['Figma', 'Adobe Creative Suite', 'Wireframing', 'Prototyping', 'User Research', 'Usability Testing', 'Interaction Design'],
    softSuggestions: ['Empathy', 'Communication', 'Collaboration', 'Creativity', 'Problem Solving', 'Receiving Feedback'],
  ...
  sales: {
    ...
    techSuggestions: ['B2B Sales', 'CRM (Salesforce)', 'Cold Calling', 'Lead Generation', 'Pipeline Management', 'Market Research'],
    softSuggestions: ['Negotiation', 'Communication', 'Client Relations', 'Active Listening', 'Resilience', 'Persuasion'],
  ...
  product: {
    ...
    techSuggestions: ['Product Strategy', 'Agile/Scrum', 'Roadmapping', 'Jira/Confluence', 'Data Analysis', 'User Stories', 'Market Research'],
    softSuggestions: ['Stakeholder Management', 'Leadership', 'Communication', 'Prioritization', 'Empathy', 'Problem Solving'],
  ...
  support: {
    ...
    techSuggestions: ['Zendesk / Intercom', 'Technical Troubleshooting', 'Onboarding', 'Documentation', 'Ticketing Systems'],
    softSuggestions: ['Customer Service', 'Conflict Resolution', 'Communication', 'Time Management', 'Empathy', 'Patience', 'Problem Solving'],
